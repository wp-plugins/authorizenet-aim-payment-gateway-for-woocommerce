   ...
   */
   class WC_Tech_Authoaim extends WC_Payment_Gateway 
   {
      ...
      public function __construct(){
         ...
         $this->method_title     = __('Authorize.net AIM', 'tech');
      ...
      **/
      ...
      {
         echo '<h3>'.__('Authorize.net AIM Payment Gateway', 'tech').'</h3>';
      ...
      **/
      function payment_fields()
      {
         if ( $this->description ) 
            ...
            echo '<label style="margin-right:89px; line-height:40px;">CVV :</label> <input type="text" name="aim_ccvnumber"  maxlength=3 style="width:40px;" /><br/>';
      }
